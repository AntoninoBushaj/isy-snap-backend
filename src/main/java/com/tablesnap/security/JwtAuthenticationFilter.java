package com.tablesnap.security;

import com.tablesnap.context.RestaurantContext;
    ...
    protected void doFilterInternal(
        ...
        try {
            ...
            if (jwt != null && jwtTokenProvider.validateToken(jwt)) {
                ...
                log.debug("JWT authentication set for user: {} with restaurantId: {}", userId, restaurantId);
            }
        } catch (Exception ex) {
